                ...
                {post.url_video && isYouTubeUrl(post.url_video) && (
                    <div className="rounded-[10px] overflow-hidden">
                        <div className="relative pt-[56.25%] bg-black rounded-t-[10px]">
                            <iframe
                                src={`https://www.youtube.com/embed/${getYouTubeId(post.url_video)}`}
                                ...
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        if (parent) {
                                            ...
                                            fallback.className = 'w-full h-64 flex flex-col items-center justify-center bg-gray-100 text-gray-400';
                                            fallback.innerHTML = `
